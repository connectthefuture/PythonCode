    ...
    $.extend({
        ...
        tooltip: function (t1, t2, t3, callback) {
            ...
            if (t3 == true && t3 != undefined) {
                tip = '<div class="HTooltip in animated" style="width:280px;padding:10px;text-align:center;background-color:#5cb85c;color:#fff;position:fixed;top:10px;left:50%;z-index:100001;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">' + t1 + '</div>';
            }
